...
`Note: I just changed from Netlify to Cloudflare Pages and opted to use TinaCMS (With Tina Cloud) instead of Decap. I couldn't figure out how to get Decap working!`
